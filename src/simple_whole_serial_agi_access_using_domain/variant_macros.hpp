...
#define Variant_Grid_access_using_domain(grid, domain, x,y,z) (Variant_Grid_access_index(grid, Variant_Domain_idx(domain,x,y,z)))
...
#define Variant_Domain_fast_loop_whole(domain, iter_x, iter_y, iter_z, body) Basic_Domain_fast_loop_whole(domain, iter_x, iter_y, iter_z, body)
...
#define Variant_Domain_fast_loop_interior(domain, iter_x, iter_y, iter_z, body) Basic_Domain_fast_loop_interior(domain, iter_x, iter_y, iter_z, body)
