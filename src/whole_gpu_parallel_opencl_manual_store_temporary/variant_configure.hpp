...
enum VariantExitCode : ExitType {
  OPENCL_PLATFORM_INTERROGATION_FAILURE = 100,
  OPENCL_DEVICE_CREATION_FAILURE        = 101,
  OPENCL_COMPILATION_FAILURE            = 102,
  OPENCL_KERNEL_CREATION_FAILURE        = 103,
  OPENCL_BUFFER_WRITE_FAILURE           = 104,
  OPENCL_BUFFER_READ_FAILURE            = 105,
  OPENCL_KERNEL_SETUP_FAILURE           = 106,
  OPENCL_KERNEL_EXECUTION_FAILURE       = 107
};
